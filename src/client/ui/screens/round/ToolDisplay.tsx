...
const ToolDisplay = (props: ToolDisplayProps): React.Element => {
	...
	useEffect(() => {
		...
		const gameCharacter = props.characterController.getCharacterComponent(GameCharacterComponent);
		if (gameCharacter) onGameCharacterAdded(gameCharacter);

		const connection = props.characterController.CharacterAdded.Connect((gameCharacter) => {
